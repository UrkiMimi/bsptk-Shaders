...
Shader "Urki/Note"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 input180 = ( ( _CustomFogColorMultiplier * _CustomFogColor ) + tex2D( _BloomPrePassTexture, localMyCustomExpression133 ) );
			...
			#endif
			o.Emission = ( ( localGammaCorrection180 * clampResult84 ) + ( temp_output_61_0 * ( switchResult159 + ( staticSwitch162 * staticSwitch144 ) + ( float4( staticSwitch123 , 0.0 ) * staticSwitch162 ) ) ) ).xyz;
...
/*ASEBEGIN
Version=18935
0;0;1536;795;-161.083;699.3128;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-620.0281,-289.6024;Inherit;False;Global;_CustomFogOffset;_CustomFogOffset;7;0;Create;True;0;0;0;False;0;False;0;1.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;146;583.0649,221.5331;Inherit;False;Property;_CutPlane;_CutPlane;18;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-563.7146,-363.1763;Inherit;False;Property;_FogOffset;Fog Offset;2;0;Create;True;0;0;0;False;0;False;0;-4.98;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-196.917,321.1872;Inherit;True;Global;_CutoutTex;_CutoutTex;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;LockedToTexture3D;False;Object;-1;Auto;Texture3D;8;0;SAMPLER3D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;181;392.7571,-758.8277;Inherit;False;Global;_CustomFogGammaCorrection;_CustomFogGammaCorrection;7;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=DE6DF4A6577D727E8896FD8CACC926C18B5D3B1A