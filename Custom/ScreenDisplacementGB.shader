...
Shader "Urki/ScreenDisplacementGB"
{
	...
	SubShader
	{
		...
		float4 fogcorrection157( float4 input, float offset )
		{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 input157 = ase_screenPosNorm;
			float offset157 = _StereoCameraEyeOffset;
			float4 localfogcorrection157 = fogcorrection157( input157 , offset157 );
			float4 input153 = tex2D( _BloomPrePassTexture, localfogcorrection157.xy );
...
/*ASEBEGIN
Version=18935
0;24;1920;987;756.7384;1002.948;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;152;263.7381,-560.3024;Inherit;False;Global;_CustomFogGammaCorrection;_CustomFogGammaCorrection;7;0;Create;True;0;0;0;False;0;False;0;2.6;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FC43E7A4D14F567BA6196AE6B05D5678819F8C19