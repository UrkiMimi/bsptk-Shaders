...
Shader "Urki/ScreenDisplacementGB"
{
	...
	SubShader
	{
		...
		float4 GammaCorrection153( float4 input, float GammaValue )
		{
			float4 clr = input;
			clr = log2(clr);
			clr *= GammaValue;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 input153 = tex2D( _BloomPrePassTexture, localMyCustomExpression74 );
			float GammaValue153 = _CustomFogGammaCorrection;
			float4 localGammaCorrection153 = GammaCorrection153( input153 , GammaValue153 );
			...
			o.Emission = ( ( localGammaCorrection153 * (( _EnableFog )?( clampResult33 ):( 0.0 )) ) + ( ( ( TransparentFog75 * temp_output_14_0 ) + ( ( ( DistortedFog87 * _TintColor ) + _AddColor ) * temp_output_10_0 ) + ( 0.0 * _CullMode ) ) * temp_output_46_0 ) ).xyz;
...
/*ASEBEGIN
Version=18935
0;0;1536;795;331.533;765.7942;1.086789;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-1306.272,-425.4887;Inherit;False;Global;_CustomFogOffset;_CustomFogOffset;7;0;Create;True;0;0;0;False;0;False;0;1.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;152;263.7381,-560.3024;Inherit;False;Global;_CustomFogGammaCorrection;_CustomFogGammaCorrection;7;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=54684815EC481DC739396D0BBFC023A17C9524B6