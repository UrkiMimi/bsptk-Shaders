...
Shader "Urki/Smoke"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 input47 = tex2D( _BloomPrePassTexture, localMyCustomExpression46 );
...
/*ASEBEGIN
Version=18935
0;0;1536;795;950.313;603.2299;1.168702;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-154.6849,-258.254;Inherit;False;Global;_CustomFogGammaCorrection;_CustomFogGammaCorrection;7;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;47;135.6692,-160.5005;Inherit;False;float4 clr = input@$clr = log2(clr)@$clr *= GammaValue@$clr = exp2(clr)@$return clr@;4;Create;2;True;input;FLOAT4;0,0,0,0;In;;Inherit;False;True;GammaValue;FLOAT;0;In;;Inherit;False;Gamma Correction;True;False;0;;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=A3DD97889B80B71E7204F00E990995BB61023525