...
Shader "Urki/ScreenDisplacementSimple"
{
	...
	SubShader
	{
		Tags{ "RenderType" = "Transparent"  "Queue" = "AlphaTest+551" "IgnoreProjector" = "True" "IsEmissive" = "true"  }
		Cull [_CullMode]
		ZWrite On
		Offset  1 , 1
		Blend One Zero
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 TransparentFog75 = ( tex2D( _BloomPrePassTexture, localMyCustomExpression74 ) * float4( 1,1,1,0 ) );
			...
			float4 DistortedFogUV91 = ( ase_screenPosNorm + float4( ( UnpackNormal( tex2D( _DisplacementTexture, uv_DisplacementTexture ) ) * ( ( 1.5 * _DisplacementIntensity ) * ( 1.0 - (( _EnableFog )?( clampResult33 ):( 0.0 )) ) ) * tex2DNode7.a * float3( float2( 1,1 ) ,  0.0 ) ) , 0.0 ) );
			...
			o.Alpha = ( temp_output_46_0 * ( ( (DistortedFog87).w * temp_output_10_0 ) + ( (TransparentFog75).a * temp_output_14_0 ) ) );
		}
...
/*ASEBEGIN
Version=18935
0;0;1536;795;283.3052;301.145;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1291.272,-566.4888;Inherit;False;Global;_CustomFogAttenuation;_CustomFogAttenuation;7;0;Create;True;0;0;0;False;0;False;0;0.015;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-813.9241,-541.6698;Inherit;False;Property;_FogScale;Fog Scale;6;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1221.094,234.8131;Inherit;False;Property;_DisplacementIntensity;Displacement Intensity;0;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;135;-988.3051,225.355;Inherit;False;2;2;0;FLOAT;1.5;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;82;-1283.591,-1031.998;Inherit;True;Global;_BloomPrePassTexture;_BloomPrePassTexture;10;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;35;-825,341.5;Inherit;False;Property;_TintColor;Tint Color;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.5019608,0.2509804,0.2509804,0.5019608;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;83;-940.234,-1046.915;Inherit;True;Property;_TextureSample1;Texture Sample 1;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;131;-556.3027,-1042.529;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;39;-324,72.5;Inherit;False;Property;_AddColor;Add Color;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1254902,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;75;-358.6812,-1064.16;Inherit;True;TransparentFog;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-234,-493.5;Inherit;False;Property;_CullMode;Cull Mode;3;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;16;572.4486,-259.3241;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;760.4147,-234.6662;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;47;938.4556,-258.5043;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=DE41C121E9DAFBDC62C26BD4248EB8F3E3EA9117