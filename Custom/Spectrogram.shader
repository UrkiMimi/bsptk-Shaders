...
Shader "Urki/Spectrogram"
{
	...
	SubShader
	{
		...
		float3 DatatoVertex102( float Data, float3 Vert, float peak )
		{
			float3 v = Vert;
			v.z *= -Data * peak;
			v.z -= 255 * peak;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float Data102 = ( tex2DNode81.r + 1.0 );
			float3 ase_vertex3Pos = v.vertex.xyz;
			float3 Vert102 = ase_vertex3Pos;
			float peak102 = _SpectrogramPeak;
			float3 localDatatoVertex102 = DatatoVertex102( Data102 , Vert102 , peak102 );
...
/*ASEBEGIN
Version=18935
409.6;493.6;1536;782;832.3296;87.49454;1.060001;True;False
Node;AmplifyShaderEditor.Vector3Node;56;-1419.848,57.181;Inherit;False;Property;_FresnelVector;FresnelVector;7;0;Create;True;0;0;0;False;0;False;0,0,0;0,-8,5;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;81;-625.0181,256.0572;Inherit;True;Property;_DataTex;_DataTex;1;0;Create;True;0;0;0;False;0;False;-1;None;;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;93;-285.5092,294.1057;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;-299.1488,548.5062;Inherit;False;Property;_SpectrogramPeak;Spectrogram Peak;8;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;102;-20.8488,302.5859;Inherit;False;float3 v = Vert@$v.z *= -Data * peak@$v.z -= 255 * peak@$return v@;3;Create;3;True;Data;FLOAT;0;In;;Inherit;False;True;Vert;FLOAT3;0,0,0;In;;Inherit;False;True;peak;FLOAT;0;In;;Inherit;False;Data to Vertex;True;False;0;;False;3;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;96;-558.2693,440.3859;Inherit;False;0;81;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4611D27E87C4E35C6853DA5ACC9089F91E01FFF6